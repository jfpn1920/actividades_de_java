...
class Cuenta {
    ...
    public void depositar(double cantidad) throws IllegalArgumentException {
        if (cantidad <= 0) {
            throw new IllegalArgumentException("error: la cantidad a depositar debe ser mayor que 0.");
        }
        saldo += cantidad;
    }
    public void retirar(double cantidad) throws IllegalArgumentException {
        if (cantidad <= 0) {
            throw new IllegalArgumentException("error: la cantidad a retirar debe ser mayor que 0.");
        }
        if (cantidad > saldo) {
...
public class clase_cuenta_con_validacion {
